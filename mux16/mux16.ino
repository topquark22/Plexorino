...
const uint8_t PIN_MA0 = 3; // addr 1's bit, to mux pin 15
const uint8_t PIN_MA1 = 5; // addr 2's bit, to mux pin 14
const uint8_t PIN_MA2 = 6; // addr 4's bit, to mux pin 13
