...
const uint8_t PIN_MA0 = 6; // addr 1's bit, to mux pin 15
const uint8_t PIN_MA1 = 7; // addr 2's bit, to mux pin 14
const uint8_t PIN_MA2 = 8; // addr 4's bit, to mux pin 13
